...
public  Date(int theYear, int theMonth, int theDay) { throw new RuntimeException("Stub!"); }
public  Date(long theDate) { throw new RuntimeException("Stub!"); }
@java.lang.Deprecated()
...
public static  java.sql.Date valueOf(java.lang.String dateString) { throw new RuntimeException("Stub!"); }
}

...
public synchronized  boolean containsValue(java.lang.Object value) { throw new RuntimeException("Stub!"); }
...
public synchronized  java.util.Set<K> keySet() { throw new RuntimeException("Stub!"); }
public synchronized  java.util.Collection<V> values() { throw new RuntimeException("Stub!"); }
public synchronized  java.util.Set<java.util.Map.Entry<K, V>> entrySet() { throw new RuntimeException("Stub!"); }

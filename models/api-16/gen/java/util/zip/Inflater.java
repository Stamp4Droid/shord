...
public synchronized  int inflate(byte[] buf, int offset, int byteCount) throws java.util.zip.DataFormatException { throw new RuntimeException("Stub!"); }
...
public synchronized  void setDictionary(byte[] dictionary) { throw new RuntimeException("Stub!"); }
public synchronized  void setDictionary(byte[] dictionary, int offset, int byteCount) { throw new RuntimeException("Stub!"); }

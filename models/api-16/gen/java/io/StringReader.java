...
{
public  StringReader(java.lang.String str) { throw new RuntimeException("Stub!"); }
...
public  int read(char[] buf, int offset, int len) throws java.io.IOException { throw new RuntimeException("Stub!"); }

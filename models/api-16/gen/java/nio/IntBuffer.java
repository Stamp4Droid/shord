...
public static  java.nio.IntBuffer wrap(int[] array, int start, int intCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.IntBuffer get(int[] dst, int dstOffset, int intCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.IntBuffer put(int[] src, int srcOffset, int intCount) { throw new RuntimeException("Stub!"); }

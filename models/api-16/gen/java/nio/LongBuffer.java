...
public static  java.nio.LongBuffer wrap(long[] array, int start, int longCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.LongBuffer get(long[] dst, int dstOffset, int longCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.LongBuffer put(long[] src, int srcOffset, int longCount) { throw new RuntimeException("Stub!"); }

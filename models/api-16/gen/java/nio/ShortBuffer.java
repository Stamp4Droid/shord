...
public static  java.nio.ShortBuffer wrap(short[] array, int start, int shortCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.ShortBuffer get(short[] dst, int dstOffset, int shortCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.ShortBuffer put(short[] src, int srcOffset, int shortCount) { throw new RuntimeException("Stub!"); }

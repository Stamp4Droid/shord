...
public  void setConnectTimeout(int timeoutMillis) { throw new RuntimeException("Stub!"); }
public  int getConnectTimeout() { throw new RuntimeException("Stub!"); }
public  void setReadTimeout(int timeoutMillis) { throw new RuntimeException("Stub!"); }

...
public class DatagramSocket {
    ...
    public DatagramSocket(int aPort) throws java.net.SocketException {
        throw new RuntimeException("Stub!");
    }

    public DatagramSocket(int aPort, java.net.InetAddress addr) throws java.net.SocketException {
        throw new RuntimeException("Stub!");
    }

    protected DatagramSocket(java.net.DatagramSocketImpl socketImpl) {
        throw new RuntimeException("Stub!");
    }

    public DatagramSocket(java.net.SocketAddress localAddr) throws java.net.SocketException {
        throw new RuntimeException("Stub!");
    }
    ...
    public synchronized void receive(java.net.DatagramPacket pack) throws java.io.IOException {
        throw new RuntimeException("Stub!");
    }
    ...
    public static synchronized void setDatagramSocketImplFactory(java.net.DatagramSocketImplFactory fac) throws java.io.IOException {
        throw new RuntimeException("Stub!");
    }

    public void bind(java.net.SocketAddress localAddr) throws java.net.SocketException {
        throw new RuntimeException("Stub!");
    }

    public void connect(java.net.SocketAddress peer) throws java.net.SocketException {
        throw new RuntimeException("Stub!");
    }
    ...
    public void setBroadcast(boolean broadcast) throws java.net.SocketException {
        throw new RuntimeException("Stub!");
    }

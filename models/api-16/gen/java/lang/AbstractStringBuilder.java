...
public  void getChars(int start, int end, char[] dst, int dstStart) { throw new RuntimeException("Stub!"); }
...
public  int codePointCount(int start, int end) { throw new RuntimeException("Stub!"); }

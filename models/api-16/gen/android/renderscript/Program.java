...
public  android.renderscript.Program.BaseProgramBuilder addTexture(android.renderscript.Program.TextureType texType, java.lang.String texName) throws java.lang.IllegalArgumentException { throw new RuntimeException("Stub!"); }
...
public  int getConstantCount() { throw new RuntimeException("Stub!"); }
public  android.renderscript.Type getConstant(int slot) { throw new RuntimeException("Stub!"); }
public  int getTextureCount() { throw new RuntimeException("Stub!"); }
public  android.renderscript.Program.TextureType getTextureType(int slot) { throw new RuntimeException("Stub!"); }
public  java.lang.String getTextureName(int slot) { throw new RuntimeException("Stub!"); }

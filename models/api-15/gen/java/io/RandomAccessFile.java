...
public final  void readFully(byte[] dst) throws java.io.IOException { throw new RuntimeException("Stub!"); }
public final  void readFully(byte[] dst, int offset, int byteCount) throws java.io.IOException { throw new RuntimeException("Stub!"); }

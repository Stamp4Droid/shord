...
public static  java.nio.FloatBuffer wrap(float[] array, int start, int floatCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.FloatBuffer get(float[] dst, int dstOffset, int floatCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.FloatBuffer put(float[] src, int srcOffset, int floatCount) { throw new RuntimeException("Stub!"); }

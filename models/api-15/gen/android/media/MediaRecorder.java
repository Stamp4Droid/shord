...
public class MediaRecorder {
    ...
    public void setAuxiliaryOutputFile(java.io.FileDescriptor fd) {
        throw new RuntimeException("Stub!");
    }

    public void setAuxiliaryOutputFile(java.lang.String path) {
        throw new RuntimeException("Stub!");
    }
    ...
    @STAMP(flows = { @Flow(from = "$MEDIA", to = "!FILE") })
    public void setOutputFile(java.io.FileDescriptor fd) throws java.lang.IllegalStateException {
        throw new RuntimeException("Stub!");
    }

    @STAMP(flows = { @Flow(from = "$MEDIA", to = "!FILE") })
    public void setOutputFile(java.lang.String path) throws java.lang.IllegalStateException {
        throw new RuntimeException("Stub!");
    }
}

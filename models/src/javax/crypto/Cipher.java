class Cipher
{
    ...
    @STAMP(flows = {@Flow(from="output",to="!ENC/DEC"), @Flow(from="$ENC/DEC",to="@return")})
    ...
    @STAMP(flows = {@Flow(from="input",to="@return"), @Flow(from="input",to="!ENC/DEC"), @Flow(from="$ENC/DEC",to="@return")})
    ...
    @STAMP(flows = {@Flow(from="input",to="output"), @Flow(from="input",to="!ENC/DEC"), @Flow(from="$ENC/DEC",to="@return")})

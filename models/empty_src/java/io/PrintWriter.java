class PrintWriter
{
	...
	@STAMP(flows = {@Flow(from="c",to="!this")})
	public  java.io.PrintWriter append(char c) { return null; }

	@STAMP(flows = {@Flow(from="csq",to="!this")})
	public  java.io.PrintWriter append(java.lang.CharSequence csq) { return null; }

	@STAMP(flows = {@Flow(from="csq",to="!this")})
	public  java.io.PrintWriter append(java.lang.CharSequence csq, int start, int end) { return null; }
}

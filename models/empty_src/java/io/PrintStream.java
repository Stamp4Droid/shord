public class PrintStream 
{
	...
	@STAMP(flows = {@Flow(from="c",to="!this")})
	public  java.io.PrintStream append(char c) { return null; }

	@STAMP(flows = {@Flow(from="csq",to="!this")})
	public  java.io.PrintStream append(java.lang.CharSequence csq) { return null; }

	@STAMP(flows = {@Flow(from="csq",to="!this")})
	public  java.io.PrintStream append(java.lang.CharSequence csq, int start, int end) { return null; }

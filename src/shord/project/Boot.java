...
public class Boot {
    ...
    private static final String SOOT_JAR_NOT_FOUND =
        "ERROR: Boot: Expected Soot to be loaded from soot.jar instead of from '%s'.";
    ...
    private static String getSootJarFile() {
        String cname = "soot/SootClass.class";
        URL url = Boot.class.getClassLoader().getResource(cname);
        if (!url.getProtocol().equals("jar"))

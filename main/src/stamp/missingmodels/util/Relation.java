...
public abstract class Relation {
	...
	/*
	 * Returns the weight of an edge generated by the relation for a
	 * given tuple.
	 */
	public abstract short getWeightFromTuple(int[] tuple);
	...
	public static class IndexRelation extends Relation {
		...
		public IndexRelation(String relationName, String firstVarType, int firstVarIndex, Integer firstCtxtIndex, String secondVarType, int secondVarIndex, Integer secondCtxtIndex, Integer labelIndex, Short weight) {
			...
			this.weight = weight == null ? (short)0 : weight; 
		...
		public IndexRelation(String relationName, String firstVarType, int firstVarIndex, Integer firstCtxtIndex, String secondVarType, int secondVarIndex, Integer secondCtxtIndex, Integer labelIndex) {
			this(relationName, firstVarType, firstVarIndex, firstCtxtIndex, secondVarType, secondVarIndex, secondCtxtIndex, labelIndex, null);
		}
		

		public IndexRelation(String relationName, String firstVarType, int firstVarIndex, Integer firstCtxtIndex, String secondVarType, int secondVarIndex, Integer secondCtxtIndex, Short weight) {
			this(relationName, firstVarType, firstVarIndex, firstCtxtIndex, secondVarType, secondVarIndex, secondCtxtIndex, null, weight);
		}
		...
		public IndexRelation(String relationName, String firstVarType, int firstVarIndex, Integer firstCtxtIndex, String secondVarType, int secondVarIndex, Integer secondCtxtIndex) {
			this(relationName, firstVarType, firstVarIndex, firstCtxtIndex, secondVarType, secondVarIndex, secondCtxtIndex, null, null);
		}
		...
		@Override
		public short getWeightFromTuple(int[] tuple) {
			return this.weight;
		}

...
public class RelationManager {
	...
	public static class IndexRelation extends Relation {
		...
		public IndexRelation(String name, String sourceName, int sourceIndex, String sinkName, int sinkIndex, String symbol, Integer fieldIndex, short weight) {
			this.name = name;
		...
		public IndexRelation(String name, String sourceName, int sourceIndex, String sinkName, int sinkIndex, String symbol, Integer fieldIndex) {
			this(name, sourceName, sourceIndex, sinkName, sinkIndex, symbol, fieldIndex, (short)0);
		}

...
public final class ContextFreeGrammar {
	public final class BinaryProduction {
		...
		public String toString() {
			return getSymbol(this.target) + " :- " + (this.isFirstInputBackwards ? "_" : "") + getSymbol(this.firstInput) + ", " + (this.isSecondInputBackwards ? "_" : "") + getSymbol(this.secondInput) + ".";
		}
	}
	...
	public void addUnaryProduction(String target, String input) {
		this.addUnaryProduction(this.getSymbolInt(target), this.getSymbolInt(input), false, false);
	}
	
	public void addUnaryProduction(String target, String input, boolean isInputBackwards) {
		this.addUnaryProduction(this.getSymbolInt(target), this.getSymbolInt(input), isInputBackwards, false);
	}
	
	public void addUnaryProduction(String target, String input, boolean isInputBackwards, boolean ignoreFields) {
		this.addUnaryProduction(this.getSymbolInt(target), this.getSymbolInt(input), isInputBackwards, ignoreFields);
	}
	
	public void addBinaryProduction(String target, String firstInput, String secondInput) {
		this.addBinaryProduction(this.getSymbolInt(target), this.getSymbolInt(firstInput), this.getSymbolInt(secondInput), false, false, false);
	}
	
	public void addBinaryProduction(String target, String firstInput, String secondInput, boolean ignoreFields) {
		this.addBinaryProduction(this.getSymbolInt(target), this.getSymbolInt(firstInput), this.getSymbolInt(secondInput), false, false, ignoreFields);
	}
	...
	public void addBinaryProduction(String target, String firstInput, String secondInput, boolean isFirstinputBackwards, boolean isSecondInputBackwards) {
		this.addBinaryProduction(this.getSymbolInt(target), this.getSymbolInt(firstInput), this.getSymbolInt(secondInput), isFirstinputBackwards, isSecondInputBackwards, false);
	}
	...
	public void addBinaryProduction(String target, String firstInput, String secondInput, boolean isFirstinputBackwards, boolean isSecondInputBackwards, boolean ignoreFields) {
		this.addBinaryProduction(this.getSymbolInt(target), this.getSymbolInt(firstInput), this.getSymbolInt(secondInput), isFirstinputBackwards, isSecondInputBackwards, ignoreFields);
	}

...
{
	private Map<String, BasicMethodInfo> methInfos = new HashMap();	
	private String className;
	private File file;
	private int lineNum;

	public static ClassInfo get(String className, File f)
	{
		Element classElem = classElem(className, f);
		if(classElem == null)
			return null;
		return new ClassInfo(className, f, classElem);
	}

	private ClassInfo(String className, File f, Element classElem)
	{
	...
	*/
	...
	public MethodInfo methodInfo(String chordSig)
	{
		...
		if(bmi == null)
			return null;
		return new MethodInfo(chordSig, this);
	}

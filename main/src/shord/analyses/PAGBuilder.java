...
public class PAGBuilder extends JavaAnalysis
{
	...
	void openRels()
	{
		relGlobalAlloc = (ProgramRel) Project.g().getTrgt("GlobalAlloc");
		relGlobalAlloc.zero();
		relAlloc = (ProgramRel) Project.g().getTrgt("Alloc");
		relAlloc.zero();
		relNewH = (ProgramRel) Project.g().getTrgt("NewH");
		relNewH.zero();
		relAssign = (ProgramRel) Project.g().getTrgt("Assign");
		relAssign.zero();
		relLoad = (ProgramRel) Project.g().getTrgt("Load");
		relLoad.zero();
		relStore = (ProgramRel) Project.g().getTrgt("Store");
		relStore.zero();
		relLoadStat = (ProgramRel) Project.g().getTrgt("LoadStat");
		relLoadStat.zero();
		relStoreStat = (ProgramRel) Project.g().getTrgt("StoreStat");
		relStoreStat.zero();

		relMmethArg = (ProgramRel) Project.g().getTrgt("MmethArg");
		relMmethArg.zero();
		relMmethRet = (ProgramRel) Project.g().getTrgt("MmethRet");
		relMmethRet.zero();
		relIinvkRet = (ProgramRel) Project.g().getTrgt("IinvkRet");
		relIinvkRet.zero();
		relIinvkArg = (ProgramRel) Project.g().getTrgt("IinvkArg");
		relIinvkArg.zero();

		relSpecIM = (ProgramRel) Project.g().getTrgt("SpecIM");
		relSpecIM.zero();
		relStatIM = (ProgramRel) Project.g().getTrgt("StatIM");
		relStatIM.zero();
		relVirtIM = (ProgramRel) Project.g().getTrgt("VirtIM");
		relVirtIM.zero();

		relVT = (ProgramRel) Project.g().getTrgt("VT");
		relVT.zero();
		relHT = (ProgramRel) Project.g().getTrgt("HT");
		relHT.zero();
		relHTFilter = (ProgramRel) Project.g().getTrgt("HTFilter");
		relHTFilter.zero();
		relMI = (ProgramRel) Project.g().getTrgt("MI");
		relMI.zero();
		relMH = (ProgramRel) Project.g().getTrgt("MH");
		relMH.zero();
		relMV = (ProgramRel) Project.g().getTrgt("MV");
		relMV.zero();
		relMU = (ProgramRel) Project.g().getTrgt("MU");
		relMU.zero();

		relAssignPrim = (ProgramRel) Project.g().getTrgt("AssignPrim");
		relAssignPrim.zero();
		relLoadPrim = (ProgramRel) Project.g().getTrgt("LoadPrim");
		relLoadPrim.zero();
		relStorePrim = (ProgramRel) Project.g().getTrgt("StorePrim");
		relStorePrim.zero();
		relLoadStatPrim = (ProgramRel) Project.g().getTrgt("LoadStatPrim");
		relLoadStatPrim.zero();
		relStoreStatPrim = (ProgramRel) Project.g().getTrgt("StoreStatPrim");
		relStoreStatPrim.zero();

		relMmethPrimArg = (ProgramRel) Project.g().getTrgt("MmethPrimArg");
		relMmethPrimArg.zero();
		relMmethPrimRet = (ProgramRel) Project.g().getTrgt("MmethPrimRet");
		relMmethPrimRet.zero();
		relIinvkPrimRet = (ProgramRel) Project.g().getTrgt("IinvkPrimRet");
		relIinvkPrimRet.zero();
		relIinvkPrimArg = (ProgramRel) Project.g().getTrgt("IinvkPrimArg");
	...
	class MethodPAGBuilder
	{
		...
		void pass1()
		{
			...
			for(ValueBox vb : body.getUseBoxes()){
				...
				StringConstantVarNode vn = globalSCVarNode;
				StringConstNode an = gscn;
	...
	void populateCallgraph()
	{
		...
		ProgramRel relChaIM = (ProgramRel) Project.g().getTrgt("chaIM");
		relChaIM.zero();
	...
	void populateMethods()
	{
		...
		ProgramRel relLibrary = (ProgramRel) Project.g().getTrgt("Library");
		relLibrary.zero();
	...
	void populateTypes()
	{
		DomT domT = (DomT) Project.g().getTrgt("T");
		Program program = Program.g();
	...
	{
		ProgramRel relSubSig = (ProgramRel) Project.g().getTrgt("SubSig");
		relSubSig.zero();
		Iterator mIt = Program.g().getMethods();
		DomM domM = (DomM) Project.g().getTrgt("M");
		while(mIt.hasNext()){
			SootMethod m = (SootMethod) mIt.next();
			if(domM.contains(m))
	...
	{
		ProgramRel relDispatch = (ProgramRel) Project.g().getTrgt("Dispatch");
		relDispatch.zero();
	...
	void populateMisc()
	{
		ProgramRel relClassT = (ProgramRel) Project.g().getTrgt("ClassT");
		relClassT.zero();
		ProgramRel relSubtype = (ProgramRel) Project.g().getTrgt("Subtype");
		relSubtype.zero();
		ProgramRel relStaticTM = (ProgramRel) Project.g().getTrgt("StaticTM");
		relStaticTM.zero();
		ProgramRel relStaticTF = (ProgramRel) Project.g().getTrgt("StaticTF");
		relStaticTF.zero();
		ProgramRel relClinitTM = (ProgramRel) Project.g().getTrgt("ClinitTM");
		relClinitTM.zero();
		...
		for(SootClass klass : program.getClasses()){
			...
			for(SootClass clazz : subTypesOf(klass))
	...
	private static List<SootMethod> overridingMethodsFor(SootMethod originalMethod)
	{
	...
	private static List<SootClass> subTypesOf(SootClass cl)
	{

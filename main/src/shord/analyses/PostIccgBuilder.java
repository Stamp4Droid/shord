...
@Chord(name="post-java-iccg",
       consumes={ "CallerComp" },
       namesOfTypes = { "M", "T", "C"},
       types = { DomM.class, DomT.class, DomC.class},
       namesOfSigns = { "CalledComp" },
       signs = { "M0,C0,T0:M0_C0_T0" }
       )
public class PostIccgBuilder extends JavaAnalysis
{
    ...
    public PostIccgBuilder()
    {
        ...
        while (iter.hasNext()) {
            ...
            System.out.println("nodeinfo:" + val.getName() +" "+ val.getType()+" " + val.getPermission()+ " " + val.getMain() + val.getIntentFilter());
            ...
            iccg.addNode(iNode);
            System.out.println("kaoooooo " + iNode.getComptName());
        }
        ...
        System.out.println("callbackList: " + callbackList);
    ...
    void parsePermission() {
        ...
        System.out.println("justtest: " + pMap.get("<com.android.voicedialer.VoiceDialerActivity: void onDestroy()>"));
    }
    ...
    void openRels()
    {
        ...
        relMI.load();
        relMM.load();
        Iterable res00 = relMI.getAry2ValTuples();
        Iterable res01 = relChaIM.getAry2ValTuples();
        Iterable res02 = relMM.getAry2ValTuples();
        /*for(Object pair : res00) {
            System.out.println("MIpair:" + pair);
        }
        for(Object pair : res01) {
            System.out.println("chaIMpair:" + pair);
        }
        for(Object pair : res02) {
            System.out.println("MMpair:" + pair);
        }*/

        System.out.println("myRelation:" +relCallerComp.getAry3ValTuples());
        Iterable<Trio<SootMethod,Ctxt,RefType>> res1 = relCallerComp.getAry3ValTuples();
        for(Trio<SootMethod,Ctxt,RefType> pair : res1) {
            //System.out.println("CCpair:" + pair);
            SootMethod mm = pair.val0;
            //RefType cc = pair.val1;
            ...
            if(stmt.containsInvokeExpr()){
                ...
                ||  methSig.equals("<android.content.ComponentName: void <init>(java.lang.String,java.lang.String)>")
                    ...
                    if(components.get(method.getDeclaringClass().getName()) == null) {
                        ...
                        System.out.println("mydeclare:" + method.getDeclaringClass().getName());
                        ...
                        while (iter.hasNext()) { 
                            ...
                            if(val.contains(method.getSignature())) {
                                ...
                                //can be a callback, which has an asynchronous call.
                                //if(callbackList.contains(klass)) {
                                    ///System.out.println("this is callback.." + callbackList + "|" + klass + "|" +  klass.getSuperclass());

                                //}
                                System.out.println("asynmethod: " + method.getSubSignature());
                    ...
                    //if (srcNode.getComptName().equals("unknown")) continue;
 ...
 private HashMap<SootClass,List<SootClass>> classToSubtypes = new HashMap();
    ...
    public SootMethod querySrc(Iterator<Edge> edgeIt, SootMethod method) {
        ...
        while(edgeIt.hasNext()){
            ...
            System.out.println("check eeg:" + method + " $$$src:" + src + " !!!! tgt: " + tgt);
            //if(method.getSignature().equals(tgt.getSignature()))
            ...
            if(tgt.isPhantom())
                continue;
            //System.out.println("stmt: "+callStmt+" tgt: "+tgt+ "abstract: "+ tgt.isAbstract());
            if(ignoreStubs){
    ...
    public void run()
    {
        ...
        for(SootClass klass: Program.g().getClasses()){
            ...
            //System.out.println("yuffkk "+klass + "||Super: " + (klass.hasSuperclass() ? klass.getSuperclass() : ""));
            this.visit(klass);
        }
        //saveRels();

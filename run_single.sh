...
mkdir -p results
echo mv ../pjbench/dacapo/benchmarks/$3/chord_output/log.txt results/log_$3_$2.txt
mv ../pjbench/dacapo/benchmarks/$3/chord_output/log.txt results/log_$3_$2.txt